    ...
    <div className="flex flex-col items-center justify-center h-full text-center">
      <div className="mb-8">
        ...
        <button
          ...
          className="mt-4 px-8 py-4 bg-slate-700 text-white text-xl font-bold rounded-lg shadow-lg hover:bg-slate-600 transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-slate-400"
        >
          查看排行榜
        </button>
